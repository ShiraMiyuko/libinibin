namespace Dargon.Plugins.InibinTroybin
{
	public enum CharacterInibinKeyHashes : uint
	{
		...
		// Skin definitions
		SkinOneName = 2142495409U,
		SkinOneSkn = 769344815U,
		SkinOneTexture = 2640183547U,
		SkinOneSkl = 1895303501U,

		SkinTwoName = 1742464788U,
		SkinTwoSkn = 306040338U,
		SkinTwoTexture = 664710616U,
		SkinTwoSkl = 599757744U,

		SkinThreeName = 1652845395U,
		SkinThreeSkn = 525951185U,
		SkinThreeTexture = 4206390233U,
		SkinThreeSkl = 3575010799U,

		SkinFourName = 1563226002U,
		SkinFourSkn = 745862032U,
		SkinFourTexture = 3453102554U,
		SkinFourSkl = 2255296558U,

		SkinFiveName = 1473606609U,
		SkinFiveSkn = 965772879U,
		SkinFiveTexture = 2699814875U,
		SkinFiveSkl = 935582317U,

		SkinSixName = 1383987216U,
		SkinSixSkn = 1185683726U,
		SkinSixTexture = 1946527196U,
		SkinSixSkl = 3910835372U,

		SkinSevenName = 1294367823U,
		SkinSevenSkn = 1405594573U,
		SkinSevenTexture = 1193239517U,
		SkinSevenSkl = 2591121131U,

		SkinEightName = 1204748430U,
		SkinEightSkn = 1625505420U,
		SkinEightTexture = 439951838U,
		SkinEightSkl = 1271406890U,
